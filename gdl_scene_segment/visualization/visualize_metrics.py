...
out_path = out_dir/ f"base_exp0_model_inputs{ext}"
...
out_path = out_dir/ f"base_exp1_mesh_preprocessing{ext}"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ f"base_exp2-4{ext}"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ f"base_exp5_0_ilr{ext}"
...
out_path = out_dir/ f"base_exp5_1_lrs{ext}"
...
out_path = out_dir/ f"base_exp5_2-3_cWidth_blocks{ext}"
draw_metrics(metrics, exp_name, 75, 0, out_path)
...
out_path = out_dir/ f"pyramid_exp0_whole_architecture{ext}"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ f"pyramid_exp1_branches{ext}"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ f"pyramid_exp2_structure{ext}"
...
out_path = out_dir/ f"pyramid_exp3_levels{ext}"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ f"pyramid_exp4_tweaks_level2{ext}"
draw_metrics(metrics, exp_name, 50, 0, out_path)
