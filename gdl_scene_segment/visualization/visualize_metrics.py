...
out_path = out_dir/ "base_exp0_model_inputs.svg"
...
out_path = out_dir/ "base_exp1_mesh_preprocessing.svg"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ "base_exp2-4.svg"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ "base_exp5_0_ilr.svg"
...
out_path = out_dir/ "base_exp5_1_lrs.svg"
...
out_path = out_dir/ "base_exp5_2-3_cWidth_blocks.svg"
draw_metrics(metrics, exp_name, 75, 0, out_path)
...
out_path = out_dir/ "pyramid_exp0_whole_architecture.svg"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ "pyramid_exp1_branches.svg"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ "pyramid_exp2_structure.svg"
...
out_path = out_dir/ "pyramid_exp3_levels.svg"
draw_metrics(metrics, exp_name, 50, 0, out_path)
...
out_path = out_dir/ "pyramid_exp4_tweaks_level2.svg"
draw_metrics(metrics, exp_name, 50, 0, out_path)
